...
def exp_run(seed, n_syms, n_dfas, n_examples):
    ...
    signal.alarm(0)
    assert signal.alarm(0) == 0
    baseline[(n_examples, n_syms, n_dfas)] = result
    print('Baseline', (n_examples, n_syms, n_dfas), baseline[(n_examples, n_syms, n_dfas)])
    ...
    signal.alarm(0)
    assert signal.alarm(0) == 0
    this_work[(n_examples, n_syms, n_dfas)] = result
    print('This Work', (n_examples, n_syms, n_dfas), this_work[(n_examples, n_syms, n_dfas)])

    f = open('exp_results/exp_baseline_seed' + str(seed) + '_n_syms' + str(n_syms) + '_n_dfas' + str(n_dfas) + '_n_examples' + str(n_examples) + '_results.csv', 'w+')
    f.write('n_examples,n_syms,n_dfas,time\n')
...
if __name__ == '__main__':
    ...
    exp_run(seed, n_syms, n_dfas, n_examples)
